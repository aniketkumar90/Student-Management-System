...
<div class="info">
    ...
    <?php
    $sql = "SELECT * FROM `sms_lsc` . `users` WHERE `users` . `user_type` = 2 and `users` . `status` = 2";
    ...
    <?php } else {
        echo "<div><h3 style='color:red; margin-top: 18%;'>No Any Approved Students Data Found!</h3></div>";
    } ?>
